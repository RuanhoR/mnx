...
export class DB {
  static get users() { return supabaseClient.from('user_table') }
  static get packages() { return supabaseClient.from('mnx_packages') }
  static get scopes() { return supabaseClient.from('mnx_scope') }
  static get readmes() { return supabaseClient.from('mnx_readme') }
  static get publishTokens() { return supabaseClient.from('publish-token') }
}
